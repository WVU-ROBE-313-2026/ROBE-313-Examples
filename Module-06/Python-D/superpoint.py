...
# ==================== Load images ====================
img0 = load_image("eiffel1.jpg")   # returns [1,3,H,W] or [3,H,W] or even grayscale
img1 = load_image("eiffel2.jpg")
...
matcher = LightGlue(
    features="superpoint",
    depth_confidence=0.95,   # only very confident keypoint detections
    width_confidence=0.95,   # only very confident matches
).eval().to(device)
...
# ==================== Visualization ====================
left  = cv2.imread("eiffel1.jpg")
right = cv2.imread("eiffel2.jpg")
