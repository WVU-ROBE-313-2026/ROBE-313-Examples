...
# Grab the very first 'best' match from the tuple
# best_match = matches[0][0]

# Look inside the object
# print(best_match.distance)   # The actual mathematical distance (used in Lowe's ratio)
# print(best_match.queryIdx)   # The index of the keypoint in Image 1
# print(best_match.trainIdx)   # The index of the matched keypoint in Image 2
